...
curl -o .cursor/rules/monad-x402.mdc https://raw.githubusercontent.com/adipundir/monad-x402/main/integration/monad-x402.mdc
```
...
- [GitHub Repository](https://github.com/adipundir/monad-x402)

## Support

For issues with the Cursor integration:
- Check the [FAQ](/docs/faq)
- Open an issue on [GitHub](https://github.com/adipundir/monad-x402/issues)
