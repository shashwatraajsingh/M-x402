...
export default function APIReferencePage() {
  ...
  useEffect(() => {
    fetch('/docs/api-reference/server-api.md')
      .then(res => res.text())
      .then(text => {
        setContent(text);
        setLoading(false);
    ...
    <div className="min-h-screen bg-gradient-to-br from-zinc-50 via-white to-zinc-100">
      ...
      <div className="container mx-auto px-6 py-12 max-w-4xl">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-zinc-200 p-8 md:p-12">
          <h1 className="text-4xl font-bold text-zinc-900 mb-4">API Reference</h1>
          <p className="text-lg text-zinc-600 mb-8">Complete API documentation for Monad x402</p>
